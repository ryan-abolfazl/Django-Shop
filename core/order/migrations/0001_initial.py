# Generated by Django 4.2.27 on 2026-01-14 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_pecent', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'در انتظار پرداخت'), (2, 'درحال پردازش'), (3, 'ارسال شده'), (4, 'تحویل شده'), (5, 'لغو شده')], default=1)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
