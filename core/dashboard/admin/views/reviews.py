...
class AdminReviewsUpdateView(LoginRequiredMixin, HasAdminAccessPermission, SuccessMessageMixin, UpdateView):
    template_name = 'dashboard/admin/reviews/review-edit.html'
    queryset = ReviewModel.objects.all()
    form_class = ReviewForm
    success_message = "ویرایش کامنت با موفقیت انجام شد"
